...
class ConRec:
    def __init__(self, parameters):
        ...
        self.headers_for_logs_csv = ['path', 'score', 'percent_filled', 'final_time']
        self.logs_dir = 'logs/logs.csv'
        self.error_logs_dir = 'logs/errors.csv'
    ...
    def evaluate_aligned_image(self):
        score = recognition.measure_similarity(self.aligned_image, self.template)
        ...
        self.estimated_values = score, percent_filled
