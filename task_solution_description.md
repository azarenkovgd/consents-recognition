...
Также в коде есть еще два типа (когда хеш уже встречался - сто процентов некорректное, а также когда вылезла ошибка при работе - отправляются на проверку оператору).
