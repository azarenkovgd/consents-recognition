...
Это пример хорошей работы программы - когда она может развернуть изображение. В большинстве случаев для этого требуется, чтобы:
1. Форма никак не отличалась от исходной (любое изменение формы - ухудшение качества разворота. изменение структуры формы - практически невозможно будет ее развернуть).
2. Качество изображения было приемлемым (буквы должны быть читаемыми).
3. Форма по возможности полностью присутствовала на изображении (пункт не обязательный, но желательный).
4. Форма была сфотографирована под прямым углом, без сильных уклонов в стороны. Это также не обязательно, но желательно.
